...
from agent.agent_tools.compatibility_checker import chemical_compatibility_checker


# This is the default prompt for general-purpose use.
SYSTEM_PROMPT = (
...
def get_graph_agent(
    ...
    The checkpointer is now instantiated inside this function.
    """
    ...
    TOOLS = [sds_retriever, unit_dilution_calculator, get_material_properties, chemical_compatibility_checker]
