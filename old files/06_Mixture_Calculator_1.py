...
from agent.agent_tools.calculator import get_molar_mass_from_pubchem
...
def render_molar_mass_search():
    ...
    if 'last_molar_mass' in st.session_state:
        st.sidebar.info(
            f"Last search result: {st.session_state['last_molar_mass']:.2f} g/mol. You can copy this value to your form.")
